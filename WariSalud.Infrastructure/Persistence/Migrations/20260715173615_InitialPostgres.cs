        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiasLaborables = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfiguracionClinica", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DuracionCitaMinutos = table.Column<int>(type: "integer", nullable: false, defaultValue: 30)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroColegiatura = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "ConfiguracionClinica",
                columns: new[] { "Id", "DiasLaborables", "HoraApertura", "HoraCierre" },
                values: new object[] { 1, "1,2,3,4,5,6", new TimeOnly(8, 0, 0), new TimeOnly(20, 0, 0) });

            migrationBuilder.CreateIndex(
                name: "IX_Cita_MedicoId_FechaHora",
                table: "Citas",
                columns: new[] { "MedicoId", "FechaHora" });

            migrationBuilder.CreateIndex(
                name: "IX_Cita_PacienteId_FechaHora",
                table: "Citas",
                columns: new[] { "PacienteId", "FechaHora" });

            migrationBuilder.CreateIndex(
                name: "IX_HorariosMedico_MedicoId",
